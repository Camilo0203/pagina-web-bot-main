        ...
        >
          ...
          {activeIndex > 0 ? (
            <button
              ...
              className="absolute -left-16 top-1/2 z-10 hidden h-12 w-12 -translate-y-1/2 items-center justify-center rounded-full bg-white/10 backdrop-blur-xl transition-all hover:bg-white/20 lg:flex"
          ...
          {activeIndex < screenshots.length - 1 ? (
            <button
              type="button"
              onClick={() => onNavigate(activeIndex + 1)}
              className="absolute -right-16 top-1/2 z-10 hidden h-12 w-12 -translate-y-1/2 items-center justify-center rounded-full bg-white/10 backdrop-blur-xl transition-all hover:bg-white/20 lg:flex"
