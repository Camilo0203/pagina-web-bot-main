  ...
  if (type === 'refunds') {
    return isEnglish
      ? {
          ...
          highlights: [
            'Subscription renewals are managed through Stripe Customer Portal.',
      ...
      : {
          ...
          lastUpdated: '2026-04-03',
          highlights: [
            'Las renovaciones y cancelaciones se gestionan desde Stripe Customer Portal.',
      ...
      ? {
          ...
          sections: [
            ...
            },
            {
              ...
              body: [
                'To speed up support, send the guild ID, the Discord account that manages the server, the billing interval purchased, and the Stripe receipt or charge identifier when available.',
              ],
              points: [
      ...
      : {
          ...
          sections: [
            ...
            },
            {
              ...
              body: [
                'Para acelerar la atencion, manda el ID del servidor, la cuenta de Discord que lo administra, el intervalo de billing comprado y el recibo o charge id de Stripe si lo tienes.',
              ],
              points: [
