    ...
    <section id="guide" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Setup Guide</h2>
          <p className="text-xl text-gray-600">Invite, configure, and launch in four quick steps.</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {steps.map((step, index) => {
            ...
            return (
              <article key={step.title} className="bg-gradient-to-br from-gray-50 to-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                ...
                <p className="text-xs uppercase tracking-wide text-purple-600 font-semibold mb-2">Step {index + 1}</p>
