  ...
  if (type === 'refunds') {
    return isEnglish
      ? {
          ...
          highlights: [
            'Subscription renewals are managed through Lemon Squeezy customer portal.',
          ...
          sections: [
            {
              ...
              body: [
                'TON618 Pro is sold as a subscription attached to a Discord server. We review refund requests manually because activation depends on Lemon Squeezy, Supabase and the Discord control plane staying aligned.',
              ...
              points: [
                'Please include the Lemon Squeezy receipt email and the affected guild ID when contacting support.',
      ...
      : {
          ...
          lastUpdated: '2026-04-03',
          highlights: [
            'Las renovaciones y cancelaciones se gestionan desde el portal de Lemon Squeezy.',
          ...
          sections: [
            {
              ...
              body: [
                'TON618 Pro se vende como una suscripcion ligada a un servidor de Discord. Revisamos cada solicitud manualmente porque la activacion depende de Lemon Squeezy, Supabase y el control plane del bot funcionando de forma consistente.',
              ...
              points: [
                'Incluye el correo del recibo de Lemon Squeezy y el ID del servidor afectado al escribirnos.',
  ...
  if (type === 'billing-contact') {
    return isEnglish
      ? {
          ...
          lastUpdated: '2026-04-03',
          highlights: [
            'Billing incidents should include the guild ID and the Lemon Squeezy receipt email when possible.',
          ...
          sections: [
            ...
            },
            {
              ...
              body: [
                'To speed up support, send the guild ID, the Discord account that manages the server, the billing interval purchased, and the Lemon Squeezy receipt or order identifier when available.',
              ],
              points: [
      ...
      : {
          ...
          lastUpdated: '2026-04-03',
          highlights: [
            'Los incidentes de cobro deben incluir el ID del servidor y, si existe, el correo del recibo de Lemon Squeezy.',
          ...
          sections: [
            ...
            },
            {
              ...
              body: [
                'Para acelerar la atencion, manda el ID del servidor, la cuenta de Discord que lo administra, el intervalo de billing comprado y el recibo u order id de Lemon Squeezy si lo tienes.',
              ],
              points: [
